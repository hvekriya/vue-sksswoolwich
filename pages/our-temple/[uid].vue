<template>
  <div class="static-page">
    <template v-if="doc">
      ...
      <section class="relative bg-gray-950 min-h-[50vh] flex flex-col justify-end py-24 lg:py-32 overflow-hidden">
        <div class="absolute inset-0 z-0">
          <img v-if="doc.data.cover_image?.url" :src="doc.data.cover_image.url"
          ...
          <div class="absolute -top-32 -left-32 w-[40rem] h-[40rem] bg-golden-500/10 rounded-full blur-[160px]"></div>
        </div>

        <UContainer class="relative z-10">
          <div class="max-w-4xl">
            <h1 class="text-5xl lg:text-8xl font-serif font-bold text-white mb-6 leading-tight">
      ...
      <UContainer class="py-20 lg:py-32">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          <div class="lg:col-span-8">
            <!-- Breadcrumbs -->
            <nav class="mb-12 flex items-center space-x-2 text-sm font-medium text-gray-900">
              <NuxtLink to="/" class="hover:text-golden-500 transition-colors">Home</NuxtLink>
              <UIcon name="i-heroicons-chevron-right" class="w-4 h-4" />
              <span class="text-gray-600 dark:text-gray-300">{{ doc.data.title[0]?.text }}</span>
            </nav>
            ...
            <!-- CTA Section -->
            <div v-if="doc.data.cta_link && doc.data.cta_text"
              class="mt-16 p-12 bg-gray-900 rounded-[3rem] text-center border border-white/5 relative overflow-hidden group">
              <div class="relative z-10">
                <h3 class="text-2xl font-serif font-bold text-white mb-6 italic">Learn more about our community</h3>
          ...
          <div class="lg:col-span-4 lg:sticky lg:top-28">
            <div v-if="doc.data.icon?.url"
              ...
              <p class="text-lg italic text-gray-500 font-serif leading-relaxed px-4">
                "Preserving the spiritual legacy of Shree Swaminarayan Bhagwan through tradition and service."
              </p>
