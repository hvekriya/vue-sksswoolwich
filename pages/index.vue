...
const { data: homeDoc, refresh: refreshHomeDoc } = await useAsyncData(
  "home-hero",
  async () => {
    try {
      ...
      const rawLive =
        ...
        "";
      const normalizedLive = normalizeEmbeddableVideoUrl(
        typeof rawLive === "string" ? rawLive : ""
      );
...
useSeoMeta({
  ...
  ogImage:
    "https://firebasestorage.googleapis.com/v0/b/sksswoolwich.appspot.com/o/cms%2Fcms_home%2Fhome%2Fhero.png?alt=media&token=ca514112-1b6e-45fa-b55a-e55cfdec2c72",
});
</script>
